...
export const authAPI = {
  ...
  updateProfile: (data) =>
    data instanceof FormData
      ? api.put("/auth/update-profile", data, { headers: { "Content-Type": "multipart/form-data" } })
...
export const hackathonAPI = {
  ...
  createJSON: (data) => api.post("/hackathons", data),
  update: (id, data) => api.put(`/hackathons/${id}`, data, { headers: { "Content-Type": "multipart/form-data" } }),
  updateJSON: (id, data) => api.put(`/hackathons/${id}`, data),
