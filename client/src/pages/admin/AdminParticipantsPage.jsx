        ...
        <div className="flex items-center justify-between border-b border-zinc-800 pb-3">
          <div>
            <h1 className="text-xl font-extrabold text-white flex items-center gap-2">
              <HiOutlineUsers className="text-emerald-400" /> Platform Participants
            </h1>
            <p className="text-zinc-400 text-xs mt-0.5">Manage all registered hackathon hackers and student participants</p>
          </div>
            ...
            <table className="data-table text-xs">
              ...
              <tbody>
                {loading ? (
                  ...
                  <tr><td colSpan={4} className="text-center text-zinc-500 py-10">No participants found</td></tr>
                ) : (
                  users.map(u => (
                    <tr key={u._id}>
                      <td>
                        <div className="flex items-center gap-2.5">
                          <div className="w-8 h-8 rounded-full bg-emerald-500/20 text-emerald-400 border border-emerald-500/30 flex items-center justify-center font-bold text-xs overflow-hidden flex-shrink-0">
